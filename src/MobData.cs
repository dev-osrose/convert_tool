  ...
  public class MobData
  {
    public void Load(string stbPath = null, string stlPath = null)
    {
      ...
      for (var i = 0; i < dataFile.RowCount; i++)
      {
        ...
        script += "  walk_speed        = " + npcWalkSpeed + ",\n";
        script += "  run_speed         = " + npcRunSpeed + ",\n";
        script += "  scale             = " + npcScale + ",\n";
        script += "  r_weapon          = " + npcRWeapon + ",\n";
        script += "  l_weapon          = " + npcLWeapon + ",\n";
        script += "  level             = " + npcLevel + ",\n";
        script += "  hp                = " + npcHp + ",\n";
        script += "  attack            = " + npcAttack + ",\n";
        script += "  hit               = " + npcHit + ",\n";
        script += "  def               = " + npcDef + ",\n";
        script += "  res               = " + npcRes + ",\n";
        script += "  avoid             = " + npcAvoid + ",\n";
        script += "  attack_spd        = " + npcAttackSpd + ",\n";
        script += "  is_magic_damage   = " + npcIsMagicDamage + ",\n";
        script += "  ai_type           = " + npcAiType + ",\n";
        script += "  give_exp          = " + npcGiveExp + ",\n";
        script += "  drop_type         = " + npcDropType + ",\n";
        script += "  drop_money        = " + npcDropMoney + ",\n";
        script += "  drop_item         = " + npcDropItem + ",\n";
        script += "  union_number      = " + npcUnionNumber + ",\n";
        script += "  need_summon_count = " + npcNeedSummonCount + ",\n";
        script += "  sell_tab0         = " + npcSellTab0 + ",\n";
        script += "  sell_tab1         = " + npcSellTab1 + ",\n";
        script += "  sell_tab2         = " + npcSellTab2 + ",\n";
        script += "  sell_tab3         = " + npcSellTab3 + ",\n";
        script += "  can_target        = " + npcCanTarget + ",\n";
        script += "  attack_range      = " + npcAttackRange + ",\n";
        script += "  npc_type          = " + npcType + ",\n";
        script += "  hit_material_type = " + npcHitMaterialType + ",\n";
        script += "  face_icon         = " + npcFaceIcon + ",\n";
        script += "  summon_mob_type   = " + npcSummonMobType + ",\n";
        script += "  quest_type        = " + npcQuestType + ",\n";
        script += "  height            = " + npcHeight + "\n";
        script += "});\n";
        /*
                script += "npc[" + i + "] = {}\n";
